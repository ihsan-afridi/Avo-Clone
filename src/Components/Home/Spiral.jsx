// src/components/Spiral.jsx
import React, { useEffect } from 'react';
import 'bootstrap/dist/css/bootstrap.min.css';
import spiralImage from '../../assets/spiral.jpg'; // Replace with your actual image path
  ...
  return (
    ...
    >
      ...
      <div className="row">
        ...
        >
          <h4 style={{ fontSize: '20px', color: '#6c757d', textAlign: 'left', marginBottom: '10px' }}>Illustration</h4>
